...
// act
int result = CathodeRayTube::processStream(strStream, tube);

// assert
EXPECT_EQ(13140, result);
}


TEST(CathodeRayTube, CrtDisplaysCorrectly) {
	std::string input = "addx 15"
		"\naddx -11"
		"\naddx 6"
		"\naddx -3"
	...
	std::string expectedDisplay = "##..##..##..##..##..##..##..##..##..##.."
		...
		"\n#######.......#######.......#######.....\n";
	// act
	CathodeRayTube::processStream(strStream, tube);
	auto display = tube.getCrtDisplay();
